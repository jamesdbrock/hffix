...
main = do
    ...
    T.putStr $ toLazyText $ execWriter $ do
        ...
        tll "/*!"
        tll "\\file"
        tll "\\brief The hffix_fields.hpp file is generated by the spec/spec-parse-fields Haskell program from the FIX Protocol specification documents in the spec/ directory."
        tll ""
        tll "Do not edit this file, instead modify the spec/spec-parse-fields program and run it from the spec/spec-parse-fields directory as shown here. You must have The Haskell Tool Stack https://haskellstack.org installed."
        tll ""
        tll "    hffix/spec/spec-parse-fields$ stack run --cwd .. > ../../include/hffix_fields.hpp"
        tll ""
